...
public class appeal extends AppCompatActivity {
    ...
    private EditText appealInputText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appealInputText = (EditText) findViewById(R.id.appealText);
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(appealInputText.getText().toString().equals("")) {
                    Toast.makeText(appeal.this,"You can't send empty text",Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(appeal.this, "Send Successfully", Toast.LENGTH_SHORT).show();
                    saveData();
                }
            }
        });
    ...
    private  void saveData() {
        ...
        documentReference.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                map.put("floor", floor);
                map.put("room", room);
                map.put("text", appealInputText.getText().toString());
                map.put("date", saveCurrentDate);
                map.put("time", saveCurrentTime);

                postRef.set(map);
                appealInputText.setText("");
            }
        });
    }
}